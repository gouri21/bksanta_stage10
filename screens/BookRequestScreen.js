...
export default class BookRequestScreen extends Component{
  ...
  renderItem = ( {item, i} ) =>{ console.log("image link ");
   let obj ={ title:item.volumeInfo.title, selfLink: item.selfLink,
     buyLink: item.saleInfo.buyLink, imageLink:item.volumeInfo.imageLinks }

     return ( 
     <ListItem key = {i}
     title={item.boookname}
     subtitle={item.reason_to_request}
     leftElement={<Image style={{height:50, width:50}}
     source={{uri:item.imageLink}}/>/>
     <TouchableHighlight style={{ alignItems: "center", backgroundColor: "#DDDDDD",
      padding: 10, width: '90%', }} activeOpacity={0.6} underlayColor="#DDDDDD"
